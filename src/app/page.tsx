    ...
    <WaitlistProvider>
      {(openModal) => (
        <div className="landing">
          <WaitlistBanner onJoin={openModal} />
          ...
          <nav className="lp-nav">
            ...
            <div className="lp-nav-links">
              ...
              <WaitlistButton onClick={openModal} className="lp-nav-cta">Join waitlist</WaitlistButton>
            </div>
          </nav>
          ...
          <section className="lp-hero">
            <div className="lp-hero-content">
              ...
              <div className="lp-hero-ctas">
                <WaitlistButton onClick={openModal} className="lp-btn-primary">Join waitlist</WaitlistButton>
          ...
          <section className="lp-pricing" id="pricing">
            ...
            <div className="lp-pricing-grid">
              <div className="lp-pr lp-pr-free">
                ...
                <WaitlistButton onClick={openModal} className="lp-pr-btn lp-pr-btn-free">Join waitlist</WaitlistButton>
              </div>
              <div className="lp-pr lp-pr-prem">
                ...
                <WaitlistButton onClick={openModal} className="lp-pr-btn lp-pr-btn-prem">Join waitlist</WaitlistButton>
              </div>
            </div>
          ...
          <section className="lp-final">
            ...
            <WaitlistButton onClick={openModal} className="lp-btn-primary">Join the waitlist</WaitlistButton>
          </section>
