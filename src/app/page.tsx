  ...
  return (
    <div className="landing">
      ...
      <section className="lp-hero">
        <div className="lp-hero-content">
          ...
          <div className="lp-hero-ctas">
            <Link href="/register" className="lp-btn-primary">Create your page free</Link>
      ...
      <section className="lp-pricing" id="pricing">
        ...
        <div className="lp-pricing-grid">
          <div className="lp-pr lp-pr-free">
            ...
            <Link href="/register" className="lp-pr-btn lp-pr-btn-free">Start free</Link>
          </div>
          <div className="lp-pr lp-pr-prem">
            ...
            <Link href="/register" className="lp-pr-btn lp-pr-btn-prem">Join early access</Link>
          </div>
        </div>
      ...
      <section className="lp-final">
        ...
        <Link href="/register" className="lp-btn-primary">Create your page</Link>
      </section>
