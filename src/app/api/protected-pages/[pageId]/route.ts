...
export async function GET(
  ...
  const pageResult = await query(
    `SELECT pp.id, pp.page_title, pp.visibility_mode, pp.bio_text, pp.button_label, pp.resume_url, pp.show_resume,
            ...
            pp.cover_url as page_cover_url, pp.cover_mode as page_cover_mode, pp.cover_logo_position as page_cover_logo_position, pp.cover_opacity as page_cover_opacity, pp.cover_position_y as page_cover_position_y,
  ...
  return NextResponse.json({
    page: {
      ...
      coverMode: page.page_cover_mode || 'photo',
      coverLogoPosition: page.page_cover_logo_position || 'above',
